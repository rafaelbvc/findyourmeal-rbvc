...
export const returnStyles = {
    ...
    imgOpenTable: "h-8 w-auto mr-2 pt-[0.1rem]",
    pOpenTable: "text-gray-700 hover:text-gray-800 text-1xl font-bold",
    divHambMenu: "flex flex-wrap animate-pulse transition duration-1000 ease-in-out h-[1.75rem] w-[1.75rem] mb-1 my-1 mr-1 pt-0 cursor-pointer border border-gray-400 bg-white hover:bg-gray-200 rounded md:hidden",
    divHambMenuItem: "text-gray-700 hover:text-gray-800 text-5xl my-[-0.2rem]",
    divHambMenuX: " h-[1.75rem] w-[1.75rem] animate-pulse transition duration-1000 ease-in-out order-2 mt-1 mb-1  pt-0 cursor-pointer border border-gray-400 rounded mr-1 md:hidden",
    ...
    divSignInUp: "justify-between w-screen min-w-[20rem] max-w-[25rem] py-1 pr-[0.3rem] order-4 md:flex  md:min-w-[13.75rem] md:max-w-[13.5rem] lg:pr-1",
    buttonSignout: "text-white ml-[54%] bg-blue-400 hover:bg-gray-200 rounded max-w-sm w-1/2 py-1 px-3 mr-[0.1rem] md:max-w-[6.25rem]"
}
