...
export const returnStyles = {
    ...
    divSignInUp: "justify-between w-screen min-w-[20rem] max-w-[25rem] py-1 pr-[0.3rem] order-4 md:flex  md:min-w-[13.75rem] md:max-w-[13.5rem] md lg:pr-2",
...
//   imgOpenTable: "h-8 w-auto mr-2 pt-[0.1rem]",
//   pOpenTable: "text-gray-700 hover:text-gray-800 text-1xl font-bold",
//   divHambMenu: "flex flex-wrap animate-pulse transition duration-1000 ease-in-out h-[1.75rem] w-[1.75rem] mt-[0.34rem] mr-1  cursor-pointer border border-gray-400 bg-white hover:bg-gray-200 rounded md:hidden",
//   divHambMenuItem: "text-gray-700 hover:text-gray-800 text-5xl",
//   divHambMenuX: " h-[1.75rem] w-[1.75rem] animate-pulse transition duration-1000 ease-in-out order-2 mt-[0.34rem] mb-1  cursor-pointer border border-gray-400 rounded mr-1 md:hidden",
//   pHambMenuX: "leading-[3px]  self-center text-gray-700 hover:text-gray-800 ml-1   text-3xl pl-[0.15rem] font-extrabold font-mono",
//   divCredits: "justify-between w-full min-w-[20rem] max-w-[25rem] border-b-2 border-dotted order-3 md:border-0 md:flex md:min-w-[17.5rem] md:max-w-[18.125rem]",
//   pDivCredits: "font-bold pl-1 text-1xl  self-center text-gray-700 hover:text-gray-800 md:flex ",
//   imgDivCredits: "w-[2.25rem] h-[2.25rem] self-center flex",
